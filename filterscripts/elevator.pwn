...
#define DIALOG_NIELSPASSWORD   	11444
#define DIALOG_RUBENPASSWORD	11445
#define DIALOG_JASMINEPASSWORD  11446
// Private:
...
static FloorNames[21][] =
{
	...
	"16th Floor",
	"17th Floor",
	"18th Floor (Owned by VNF)",
	"19th Floor (Owned by VNF)",
	"Tang Ham Xe"
};
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    if(dialogid == DIALOG_ID)
    {
		...
		{
			ShowPlayerDialog(playerid, DIALOG_NIELSPASSWORD, DIALOG_STYLE_PASSWORD, "Please enter the Password", "This Floor belongs to Niels and requires a password\nPlease enter the password below", "Enter", "Cancel");
		}
		else if(listitem == 18)
		{
		    ShowPlayerDialog(playerid, DIALOG_RUBENPASSWORD, DIALOG_STYLE_PASSWORD, "Please enter the Password", "This Floor belongs to Ruben and requires a password\nPlease enter the password below", "Enter", "Cancel");
		}
		else if(listitem == 17)
		{
		    ShowPlayerDialog(playerid, DIALOG_JASMINEPASSWORD, DIALOG_STYLE_PASSWORD, "Please enter the Password", "This Floor belongs to Jasmine and requires a password\nPlease enter the password below", "Enter", "Cancel");
		}
		else
    ...
    if(dialogid == DIALOG_NIELSPASSWORD)
	{
		if(response)
		{
			if(strcmp(inputtext, "huynhanh") == 0)
			{
	...
	if(dialogid == DIALOG_RUBENPASSWORD)
	{
		if(response)
		{
			if(strcmp(inputtext, "huynhanh") == 0)
			{
			    CallElevator(playerid, 18);
			}
			else return ShowPlayerDialog(playerid, DIALOG_RUBENPASSWORD, DIALOG_STYLE_PASSWORD, "Please enter the Password", "This Floor belongs to Ruben and requires a password\nYou entered the wrong Password!\nPlease try again or press Cancel", "Enter", "Cancel");
		}
		else if(!response)
		{
            ShowElevatorDialog(playerid);
	...
	if(dialogid == DIALOG_JASMINEPASSWORD)
	{
		if(response)
		{
			if(strcmp(inputtext, "huynhanh") == 0)
			{
			    CallElevator(playerid, 17);
			}
			else return ShowPlayerDialog(playerid, DIALOG_NIELSPASSWORD, DIALOG_STYLE_PASSWORD, "Please enter the Password", "This Floor belongs to Jasmine and requires a password\nYou entered the wrong Password!\nPlease try again or press Cancel", "Enter", "Cancel");
		}
		else if(!response)
		{
            ShowElevatorDialog(playerid);
...
stock Elevator_Initialize()
{
	...
	Label_Elevator          = Create3DTextLabel("{CCCCCC}Press '{FFFFFF}N'{CCCCCC} to use elevator", 0xCCCCCCAA, 1784.9822, -1302.0426, 13.6491, 4.0, 0, 1);
